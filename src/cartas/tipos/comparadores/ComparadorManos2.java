...
public class ComparadorManos2 implements Comparator<Integer[]> {
	public int compare(Integer[] mano1, Integer[] mano2) {
		Figura f1 = Figuras.getFigura(Arrays.asList(mano1));
		Figura f2 = Figuras.getFigura(Arrays.asList(mano2));
